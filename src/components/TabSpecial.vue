  ...
  .tabs-d__header
    .row.m-0
      .col-auto.arrow.align-self-center
        img(src="@/assets/curso/tabs-arrow-1.svg" style="position: relative")
      .col-sm-12.col-lg-3.col-xl.tabs-d__tab(
      ...
      .col-auto.arrow.align-self-center
        img(src="@/assets/curso/tabs-arrow-2.svg" style="position: relative")
